"""
Auto-generated launch for walker2d_v5. Same toggleable add-ons as cartpole.launch.py:
...
def generate_launch_description():
    ...
    world_path = os.path.join(resources, 'worlds', 'walker2d_v5.sdf')
    ...
    # ros_gz_bridge driven by config/walker2d_v5_bridge.yaml. Topic list
    ...
    bridge_config = os.path.join(
        bringup_share, 'config', 'walker2d_v5_bridge.yaml',
    )
    ros_gz_bridge = Node(
    ...
    bag_path = os.path.join('rosbags', f'walker2d_v5_{ts}')
