"""
Auto-generated launch for hopper. Same toggleable add-ons as cartpole.launch.py:
...
def generate_launch_description():
    ...
    world_path = os.path.join(resources, 'worlds', 'hopper.sdf')
    ...
    # ros_gz_bridge driven by config/hopper_bridge.yaml. Topic list
    ...
    bridge_config = os.path.join(
        bringup_share, 'config', 'hopper_bridge.yaml',
    )
    ros_gz_bridge = Node(
    ...
    bag_path = os.path.join('rosbags', f'hopper_{ts}')
