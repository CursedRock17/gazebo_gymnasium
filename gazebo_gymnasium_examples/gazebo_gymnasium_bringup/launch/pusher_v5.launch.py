"""
Auto-generated launch for pusher_v5. Same toggleable add-ons as cartpole.launch.py:
...
def generate_launch_description():
    ...
    world_path = os.path.join(resources, 'worlds', 'pusher_v5.sdf')
    ...
    # ros_gz_bridge driven by config/pusher_v5_bridge.yaml. Topic list
    ...
    bridge_config = os.path.join(
        bringup_share, 'config', 'pusher_v5_bridge.yaml',
    )
    ros_gz_bridge = Node(
    ...
    bag_path = os.path.join('rosbags', f'pusher_v5_{ts}')
