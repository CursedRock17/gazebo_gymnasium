"""
Auto-generated launch for inverted_double_pendulum. Same toggleable add-ons as cartpole.launch.py:
...
def generate_launch_description():
    ...
    world_path = os.path.join(resources, 'worlds', 'inverted_double_pendulum.sdf')
    ...
    # ros_gz_bridge driven by config/inverted_double_pendulum_bridge.yaml. Topic list
    ...
    bridge_config = os.path.join(
        bringup_share, 'config', 'inverted_double_pendulum_bridge.yaml',
    )
    ros_gz_bridge = Node(
    ...
    bag_path = os.path.join('rosbags', f'inverted_double_pendulum_{ts}')
