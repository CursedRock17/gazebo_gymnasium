"""
Auto-generated launch for swimmer. Same toggleable add-ons as cartpole.launch.py:
...
def generate_launch_description():
    ...
    world_path = os.path.join(resources, 'worlds', 'swimmer.sdf')
    ...
    # ros_gz_bridge driven by config/swimmer_bridge.yaml. Topic list
    ...
    bridge_config = os.path.join(
        bringup_share, 'config', 'swimmer_bridge.yaml',
    )
    ros_gz_bridge = Node(
    ...
    bag_path = os.path.join('rosbags', f'swimmer_{ts}')
