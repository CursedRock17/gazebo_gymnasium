#!/usr/bin/env python3
"""Train Hopper in Gazebo with PPO (Stable-Baselines3).
...
def parse_args():
    ...
    p.add_argument("--save-path", default="hopper_ppo")
    p.add_argument("--tensorboard-log", default="./tb_logs_hopper")
...
def main():
    args = parse_args()
    env = HopperEnv(steps_per_action=4)
    ...
    # PPO hyperparameters tuned for continuous locomotion tasks
    model = PPO(
        "MlpPolicy",
        env,
        verbose=1,
