#!/usr/bin/env python3
"""Train HalfCheetah in Gazebo with PPO (Stable-Baselines3).
...
def parse_args():
    ...
    p.add_argument("--save-path", default="half_cheetah_ppo")
    p.add_argument("--tensorboard-log", default="./tb_logs_half_cheetah")
...
def main():
    args = parse_args()
    env = HalfCheetahEnv(steps_per_action=5)
