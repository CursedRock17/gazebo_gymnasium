"""Full Reacher training stack.

Usage:
    ros2 launch gazebo_gymnasium_examples reacher_full.launch.py
    ros2 launch gazebo_gymnasium_examples reacher_full.launch.py headless:=true
    ros2 launch gazebo_gymnasium_examples reacher_full.launch.py timesteps:=500000
"""
import os
...
def generate_launch_description():
    timesteps_arg = DeclareLaunchArgument("timesteps", default_value="500000")
    ...
    world_path = PathJoinSubstitution([examples_share, "reacher", "worlds", "reacher.sdf"])
    ...
    bridge = TimerAction(period=3.0, actions=[Node(
        ...
        arguments=[
            ...
            "/world/reacher/model/reacher/joint_state@sensor_msgs/msg/JointState[gz.msgs.Model",
        ],
        output="screen",
    )])
    ...
    script_dir = os.path.join(
        ...
        "lib", "gazebo_gymnasium_examples", "reacher",
    )
