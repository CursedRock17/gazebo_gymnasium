...
class GazeboMultiAgent(gazebo_base_environment.GazeboBaseEnv):

    def __init__(self, obs_space, act_space):
        """Initialize a multi-agent Gymnasium environment alongside Gazebo configure."""
    ...
    def configure(self, entity, element, ecm, eventManager):
        ...
        self.desired_topic = element.get_string("desired_topic")
